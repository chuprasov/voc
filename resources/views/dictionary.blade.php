                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="basis-auto xl:basis-3/4 w-full space-y-4 p-4 {{ $loop->index % 2 == 0 ? 'bg-gray-200' : 'bg-gray-300' }} text-dark">
                                <div class="lg:flex items-start lg:items-center">
                                    ...
                                    <div class="flex items-center flex-shrink-1 mt-2 lg:mt-0">
                                        <div class="flex flex-row space-x-3 ml-[13px] lg:ml-5 min-h-[25px] min-w-[35px]">
                                ...
                                <div class="flex justify-between items-end lg:items-center">
                                    ...
                                    <div class="flex items-center">
                                        <div class="lg:flex">
                                            <p class="text-black text-lg mb-[-6px] lg:mb-0" id="imp">
                                               Imp.
                                            </p>
                                            <p class="text-black text-lg" id="imp">
                                                {{ $translation->dictionaryEntry->importance }}%
                                            </p>
                                        </div>
                                        <button id="edit-entry" onclick="Livewire.dispatch(
                                            'openModal',
