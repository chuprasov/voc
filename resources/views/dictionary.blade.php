                ...
                <section>
                    <div class="flex flex-col">
                        ...
                        <div class="basis-auto xl:basis-3/4 w-full space-y-4 p-4 {{ $loop->index % 2 == 0 ? 'bg-gray-200' : 'bg-gray-300' }} text-dark">
                                <div class="flex">
                                    <div class="flex flex-col lg:flex-row lg:space-x-4 lg:space-y-0">
                                        <div class="flex items-center border border-black border-solid p-3 rounded-lg bg-[#e5e7eb]">
                                            <div class="flex mr-2 mt-1">
                                                <img src="{{ asset('images/' . $translation->dictionaryEntry->lang . '.png') }}"
                                                    alt="" height="15" width="25">
                                            </div>

                                            <p class="text-black font-bold text-4xl">
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex flex-row space-x-3 ml-5 mr-2 mt-1">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <button onclick="Livewire.dispatch(
                                            ...
                                            { component: 'dictionary-entry', arguments: {
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="55px" height="35px" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <button id="deleat-article" class="ml-[-7px]">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="55px" height="35px" viewBox="0 0 24 24" fill="none">
